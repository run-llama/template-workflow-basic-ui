...
export default function Home() {
  ...
  const [selectedWorkflow, setSelectedWorkflow] = useState(
    ["dragon", "cow"].includes(deploymentName) ? deploymentName : "dragon"
  );
  ...
  return (
    <div className="flex flex-col min-h-screen p-6 sm:p-8 font-sans">
      <main className="flex-1 flex flex-col gap-8 items-center justify-center max-w-3xl mx-auto w-full">
        <button
        ...
        <div className="w-full p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
          ...
          {result && (
            <div className="mt-4">
              ...
              <pre className="p-3 bg-gray-100 dark:bg-gray-700 rounded-md overflow-auto text-sm max-h-128">{result}</pre>
            </div>
          )}
        </div>
      </main>
